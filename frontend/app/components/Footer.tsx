...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#161616] border-t border-white/8">
      <div className="container-luxury">
          ...
          <div className="mb-6 md:mb-0">
            ...
            <div className="flex items-center gap-2.5 mb-5">
              ...
              <div>
                ...
                <p className="text-[0.5rem] tracking-[0.42em] text-[#8B5A3C] uppercase font-bold mt-0.5">Nature Retreat</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <a
                ...
                className="w-8 h-8 border border-white/15 flex items-center justify-center text-white/40 hover:text-[#8B5A3C] hover:border-[#8B5A3C]/50 transition-all duration-300"
              >
              ...
              {/* Pinterest */}
              <a href="#" aria-label="Pinterest" className="w-8 h-8 border border-white/15 flex items-center justify-center text-white/40 hover:text-[#8B5A3C] hover:border-[#8B5A3C]/50 transition-all duration-300">
                <svg viewBox="0 0 24 24" className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="1.5">
          ...
          {Object.entries(NAV_COL).map(([group, links]) => {
            ...
            return (
              <div key={group} className="border-b border-white/5 md:border-none">
                ...
                >
                  <span className="text-[0.65rem] tracking-[0.4em] uppercase text-[#8B5A3C] font-semibold">
                    {group}
                  </span>
                  {isMobile && (
                    <motion.span
                  ...
                  <ul className="flex flex-col gap-3 pb-4 md:pb-0">
                    {links.map((link) => (
                      <li key={link}>
                        <a
                          href="#"
                          className="text-xs text-white/35 hover:text-[#8B5A3C] transition-colors duration-300"
                        >
                          {link}
                        </a>
                      </li>
        ...
        {/* Divider */}
        <div className="h-px bg-gradient-to-r from-transparent via-[#8B5A3C]/25 to-transparent" />
